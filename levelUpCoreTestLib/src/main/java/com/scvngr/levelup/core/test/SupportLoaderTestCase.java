 ...
 * instead of the default implementation. Modifications Copyright (C) 2014 SCVNGR, Inc. d/b/a
 * LevelUp
 *
 ...
 *
 * The original AOSP implementation is also Apache licensed; Copyright (C) 2010 The Android Open
 * Source Project.
 */
