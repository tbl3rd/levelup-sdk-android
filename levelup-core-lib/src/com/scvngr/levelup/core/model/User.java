// Generated by delombok at Mon Apr 07 22:01:06 HST 2014
/*
...
public final class User implements Parcelable {
    ...
    public User(@Nullable final String bornAt, @Nullable final Map<String, String> customAttributes, @Nullable final String email, @Nullable final String firstName, @Nullable final Gender gender, @Nullable final MonetaryValue globalCredit, final long id, final boolean isConnectedToFacebook, @Nullable final String lastName, final int merchantsVisitedCount, final int ordersCount, @Nullable final String termsAcceptedAt, @Nullable final MonetaryValue totalSavings) {
        this(bornAt, isConnectedToFacebook, customAttributes, false, email, firstName, gender, globalCredit, id, lastName, merchantsVisitedCount, ordersCount, termsAcceptedAt, totalSavings);
    }
     ...
     */
    public User(@Nullable final String bornAt, final boolean isConnectedToFacebook, @Nullable final Map<String, String> customAttributes, final boolean isDebitCardOnly, @Nullable final String email, @Nullable final String firstName, @Nullable final Gender gender, @Nullable final MonetaryValue globalCredit, final long id, @Nullable final String lastName, final int merchantsVisitedCount, final int ordersCount, @Nullable final String termsAcceptedAt, @Nullable final MonetaryValue totalSavings) {
        this.bornAt = bornAt;
    ...
    public static class UserBuilder {
        ...
        @SuppressWarnings("all")
        public UserBuilder isDebitCardOnly(final boolean isDebitCardOnly) {
            this.isDebitCardOnly = isDebitCardOnly;
            return this;
        }
        ...
        @SuppressWarnings("all")
        public User build() {
            return new User(bornAt, isConnectedToFacebook, customAttributes, isDebitCardOnly, email, firstName, gender, globalCredit, id, lastName, merchantsVisitedCount, ordersCount, termsAcceptedAt, totalSavings);
        }

        @Override
        @SuppressWarnings("all")
        public String toString() {
            return "User.UserBuilder(bornAt=" + this.bornAt + ", isConnectedToFacebook=" + this.isConnectedToFacebook + ", customAttributes=" + this.customAttributes + ", isDebitCardOnly=" + this.isDebitCardOnly + ", email=" + this.email + ", firstName=" + this.firstName + ", gender=" + this.gender + ", globalCredit=" + this.globalCredit + ", id=" + this.id + ", lastName=" + this.lastName + ", merchantsVisitedCount=" + this.merchantsVisitedCount + ", ordersCount=" + this.ordersCount + ", termsAcceptedAt=" + this.termsAcceptedAt + ", totalSavings=" + this.totalSavings + ")";
        }
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (this.isDebitCardOnly() != other.isDebitCardOnly()) return false;
    ...
    public int hashCode() {
        ...
        result = result * PRIME + (this.isDebitCardOnly() ? 2609 : 2591);
    ...
    @SuppressWarnings("all")
    public String toString() {
        return "User(bornAt=" + this.getBornAt() + ", isConnectedToFacebook=" + this.isConnectedToFacebook() + ", customAttributes=" + this.getCustomAttributes() + ", isDebitCardOnly=" + this.isDebitCardOnly() + ", email=" + this.getEmail() + ", firstName=" + this.getFirstName() + ", gender=" + this.getGender() + ", globalCredit=" + this.getGlobalCredit() + ", id=" + this.getId() + ", lastName=" + this.getLastName() + ", merchantsVisitedCount=" + this.getMerchantsVisitedCount() + ", ordersCount=" + this.getOrdersCount() + ", termsAcceptedAt=" + this.getTermsAcceptedAt() + ", totalSavings=" + this.getTotalSavings() + ")";
    }
}