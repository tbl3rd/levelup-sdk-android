// Generated by delombok at Mon Feb 03 17:57:02 EST 2014
/*
...
public final class Location implements Parcelable {
    ...
    public Location(@Nullable final Set<Integer> categories, @Nullable final String extendedAddress, @Nullable final String hours, final long id, final double latitude, final double longitude, @Nullable final String locality, final long merchantId, @Nullable final String merchantName, @Nullable final String name, @Nullable final String phone, @Nullable final String postalCode, @Nullable final String region, final boolean shown, @Nullable final String streetAddress, @Nullable final Map<String, String> urls) {
        if (null == categories) {
            ...
            this.categories = NullUtils.nonNullContract(Collections.<Integer>unmodifiableSet(categories));
        }
         ...
         */
        this.urls = NullUtils.nonNullContract(Collections.unmodifiableMap(null == urls ? new HashMap<String, String>(0) : urls));
    }
    ...
    public boolean equals(final Object o) {
        ...
        final Object this$extendedAddress = this.getExtendedAddress();
        final Object other$extendedAddress = other.getExtendedAddress();
    ...
    public int hashCode() {
        ...
        final Object $extendedAddress = this.getExtendedAddress();
        ...
        result = result * PRIME + (this.isShown() ? 2609 : 2591);
