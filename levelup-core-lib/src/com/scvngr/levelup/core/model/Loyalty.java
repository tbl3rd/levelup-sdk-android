...
public final class Loyalty implements Parcelable {
    ...
    public boolean equals(final Object o) {
        ...
        final Object this$potentialCredit = this.getPotentialCredit();
        final Object other$potentialCredit = other.getPotentialCredit();
        ...
        final Object this$shouldSpend = this.getShouldSpend();
        final Object other$shouldSpend = other.getShouldSpend();
        if (this$shouldSpend == null ? other$shouldSpend != null : !this$shouldSpend.equals(other$shouldSpend)) return false;
        final Object this$spendRemaining = this.getSpendRemaining();
        final Object other$spendRemaining = other.getSpendRemaining();
        if (this$spendRemaining == null ? other$spendRemaining != null : !this$spendRemaining.equals(other$spendRemaining)) return false;
        final Object this$totalVolume = this.getTotalVolume();
        final Object other$totalVolume = other.getTotalVolume();
        if (this$totalVolume == null ? other$totalVolume != null : !this$totalVolume.equals(other$totalVolume)) return false;
        final Object this$willEarn = this.getWillEarn();
        final Object other$willEarn = other.getWillEarn();
    ...
    public int hashCode() {
        final int PRIME = 277;
        int result = 1;
        result = result * PRIME + (this.isLoyaltyEnabled() ? 2609 : 2591);
        ...
        final Object $potentialCredit = this.getPotentialCredit();
