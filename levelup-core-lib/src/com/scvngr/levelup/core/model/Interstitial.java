...
public final class Interstitial implements Parcelable {
	...
	@java.lang.SuppressWarnings("all")
	public java.lang.String toString() {
		return "Interstitial(action=" + this.getAction() + ", descriptionHtml=" + this.getDescriptionHtml() + ", imageUrl=" + this.getImageUrl() + ", title=" + this.getTitle() + ", type=" + this.getType() + ")";
	}
	
	@java.lang.SuppressWarnings("all")
	public Interstitial(@Nullable final InterstitialAction action, @NonNull final String descriptionHtml, @NonNull final String imageUrl, @NonNull final String title, @NonNull final String type) {
