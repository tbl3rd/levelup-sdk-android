...
public final class AbstractNetworkRequestServiceTest extends AndroidTestCase {
    ...
    /**
     * Tests {@link NetworkRequestServiceUnderTest#performRequest(android.content.Context, Intent)}
    ...
    /**
     * Tests {@link NetworkRequestServiceUnderTest#performRequest(Context, Intent)} with a valid
     * request passed.
     *
     * @throws InterruptedException on interruption
     * @throws BadRequestException on a bad request
     */
    @SmallTest
    ...
    /**
     * Tests {@link AbstractNetworkRequestService#getRequest(Intent)}.
     */
    @SmallTest
    ...
    /**
     * Tests {@link AbstractNetworkRequestService#getToken()}. NOTE: this test is obviously not
    ...
    /**
     * Tests
     * {@link AbstractNetworkRequestService#onRequestFinished(Context, Intent, LevelUpResponse, boolean)}
     * .
     *
     * @throws InterruptedException on interruption
     */
    ...
    /**
     * A concrete implementation of {@link AbstractNetworkRequestService} which counts calls to
     * {@link #handleResponse(Context, LevelUpResponse)}.
     */
