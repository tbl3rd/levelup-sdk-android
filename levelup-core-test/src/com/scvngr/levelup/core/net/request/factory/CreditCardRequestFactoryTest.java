...
public final class CreditCardRequestFactoryTest extends AndroidTestCase {
    ...
    /**
     * Tests
     * {@link CreditCardRequestFactory#buildCreateCardRequest(String, String, String, String, String)}
     * .
     */
    @SmallTest
     ...
     * .
     *
     * @throws BadRequestException if the request throws
    ...
    /**
     * Tests {@link CreditCardRequestFactory#buildGetCardsRequest()}.
     *
    ...
    /**
     * Tests {@link CreditCardRequestFactory#buildPromoteCardRequest(CreditCard)}.
     *
     * @throws BadRequestException
     * @throws JSONException
     */
