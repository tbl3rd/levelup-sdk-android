...
/**
 * An {@link OnImageLoaded} implementation that has a {@link CountDownLatch} which decrements when
 * {@link #onImageLoaded(String, LevelUpQrCodeImage)} is called.
 */
public final class LatchedOnImageLoaded implements OnImageLoaded<LevelUpQrCodeImage> {
     ...
     *        {@link #onImageLoaded(String, LevelUpQrCodeImage)}. The countdown only triggers when
     *        this key is passed.
     */
